...
BOEFFLA_VERSION="UNOFFICIAL-Fusion-3.5"
FILENAME="fusion-kernel-3.5-OnePlus3"
...
step0_copy_code()
{
	...
	sed "s/\`echo \$LINUX_COMPILE_HOST | \$UTS_TRUNCATE\`/kenzolo/g" -i $BUILD_PATH/scripts/mkcompile_h
}
